(function (){
  var root = this;
  var that = browser.extension.getBackgroundPage();
  console.log("Hello World! - oauth2.js")
    ...
    $.ajax({
      ...
      .always(function (data, textStatus, jqXHR){
        if ( textStatus == "success" ) {
          ...
          console.log("Response received unsuccessfully");
          callback(data);
        }
      });
  }
  ...
  var Adapter = function (id, opts, flow){
    ...
    this._watchInject();
    //extend(this, new EventEmitter()); //Commented because EventEmitter was undefined
    if ( !isFirefox ) {
      this.syncGet();
      this.sync();
    }
  ...
  Adapter.prototype.authorize = function (callback){
    ...
    console.log("Opening this tab: " + this.codeUrl);
